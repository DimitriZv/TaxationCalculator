...
namespace Library
{   
// non resident 2018-2019 test cases
public class UnitTestNonResident1819
    {
        ...
        public double expectedResult(int indexValue, double testAmount)
        {
            switch(indexValue)
            {
                ...
                case 2:
                    return ((testAmount - ranges[indexValue-1]) * 0.37) + 29250;
                case 3:
                    return ((testAmount - ranges[indexValue-1]) * 0.45) + 62550;
